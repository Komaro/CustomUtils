...
public static partial class EditorCommon {
    ...
    public static bool DrawFixButton(GUIContent buttonContent, float width = 20f, float height = 20f, GUIStyle style = null) => GUILayout.Button(buttonContent, style ?? Constants.Draw.FIT_X2_BUTTON, GUILayout.Width(width), GUILayout.Height(height));
    ...
    public static void DrawLabelToggle(ref bool toggle, string label, string tooltip, float labelWidth = 300f) => DrawLabelToggle(ref toggle, new GUIContent(label, tooltip), GUILayout.Width(labelWidth));

    public static void DrawLabelToggle(ref bool toggle, GUIContent labelContent, params GUILayoutOption[] labelOptions) {
        using (new GUILayout.HorizontalScope(Constants.Draw.TOGGLE_HORIZONTAL_SCOPE)) {
            EditorGUILayout.LabelField(labelContent, Constants.Draw.LABEL, labelOptions);
    ...
    public static void DrawLabelToggle(ref bool toggle, string label, Action onChanged, float labelWidth = 300f) => DrawLabelToggle(ref toggle, label, onChanged, GUILayout.Width(labelWidth));

    public static void DrawLabelToggle(ref bool toggle, string label, Action onChanged, params GUILayoutOption[] labelOptions) {
        using (new GUILayout.HorizontalScope(Constants.Draw.TOGGLE_HORIZONTAL_SCOPE)) {
    ...
    public static void DrawLabelToggle(ref bool toggle, GUIContent labelContent, Action onChanged, float labelWidth = 300f) => DrawLabelToggle(ref toggle, labelContent, onChanged, GUILayout.Width(labelWidth));
