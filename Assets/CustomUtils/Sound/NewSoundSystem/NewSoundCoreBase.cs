...
public abstract class NewSoundCoreBase : MonoBehaviour, IDisposable {
    ...
    protected HashSet<Enum> _cacheSnapshotEnumSet = new();
    // private Dictionary<Enum, List<SoundAssetInfo>> _cacheSoundInfoDic = new();
    // private Dictionary<string, Enum> _cacheSoundEnumDic = new();
    
    protected ConcurrentDictionary<Enum, List<SoundAssetInfo>> _cacheSoundInfoDic = new();
    protected ConcurrentDictionary<string, Enum> _cacheSoundEnumDic = new();
    ...
    public abstract void SetVolume(Enum type, float volume);
    ...
    public abstract void SetVolume<T>(T type, float volume) where T : struct, Enum; 
...
public abstract class UnitySoundCore : NewSoundCoreBase {
    ...
    // TODO. Here
    public override float GetVolume<T>(T type) => throw new NotImplementedException();

    public override void SetVolume(Enum type, float volume) {
        throw new NotImplementedException();
    }

    public override void SetVolume<T>(T type, float volume) {
        throw new NotImplementedException();
    }

    protected override List<SoundAssetInfo> LoadSoundAssetInfoList() => throw new NotImplementedException();
    ...
    public virtual Dictionary<Enum, AudioMixerGroup> GetAudioMixerGroupDic(Enum masterType) => _mixerGroupDic.TryGetValue(masterType, out var groupDic) ? groupDic : null;
