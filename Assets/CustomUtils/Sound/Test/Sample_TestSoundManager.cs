...
/// </summary>
public class Sample_TestSoundManager : Singleton<Sample_TestSoundManager> {
    ...
    public Sample_TestSoundManager() {
    ...
    private SoundBase GetMatchSound(SoundOrder soundOrder) => soundDic.TryGetValue(soundOrder.masterType, soundOrder.representControlEnum, out var soundBase) ? soundBase : null;
